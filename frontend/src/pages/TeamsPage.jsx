...
export default function TeamsPage({ user }) {
  ...
  const [editingTemplate, setEditingTemplate] = useState(null); // template to edit
  ...
  const isOwner = selectedTeam && selectedTeam.created_by === user.id;
                ...
                <div className="members-list">
                  {members.map((m) => (
                    <div key={m.user_id} className="member-row">
                      ...
                      <span className={`member-role role-${m.role}`}>{m.role === "owner" ? "Owner" : "Mitglied"}</span>
